package br.com.jeftavares.spring_ai_jeftavares.controller;
...
import br.com.jeftavares.spring_ai_jeftavares.service.ChatService;
import br.com.jeftavares.spring_ai_jeftavares.service.ImageService;
import br.com.jeftavares.spring_ai_jeftavares.service.RecipeService;
...
public class GenerateAIController {
    ...
    public List<String> generateImages(@RequestParam String prompt,
        ...
        // Pega a lista de URLs das imagens geradas
